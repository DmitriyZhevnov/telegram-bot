...
func NewAuthorizationServer(pc *pocket.Client, tr repository.TokenRepository, rURL string) *AuthorizationServer {
	return &AuthorizationServer{pocketClient: pc, tokenRepository: tr, redirectURL: rURL}
}
